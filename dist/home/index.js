...
(() => {
  ...
  var GRAY = "#3d414e";
  var WHITE = "#ffffff";
  var BG_RO_GRADIENT = `linear-gradient(115deg, ${RED}, ${ORANGE})`;
  ...
  window.Webflow.push(() => {
    ...
    function functionalitySuiteComponent() {
      ...
      gsapWithCSS.set(bulletHeadings[0], { backgroundImage: BG_RO_GRADIENT });
      ...
      function handleOnComplete(stepNumber) {
        ...
        gsapWithCSS.set(bulletLines, { height: "10%" });
        gsapWithCSS.to(bullets[stepNumber], { backgroundColor: RED, borderColor: RED });
        gsapWithCSS.to(bulletHeadings[stepNumber], { backgroundImage: BG_RO_GRADIENT });
      }
    }
